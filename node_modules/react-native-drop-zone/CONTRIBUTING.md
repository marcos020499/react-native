# Contributing to React Native Drop Zone
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone git@github.com:YOUR_USERNAME/react-native-drop-zone.git
   # Navigate to the newly cloned directory
   cd react-native-drop-zone
   # Assign the original repo to a remote called "upstream"
   git remote add upstream git@github.com:WeTransfer/react-native-drop-zone.git
   ```
